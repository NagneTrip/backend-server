...
class FollowRestControllerTest {
    ...
    @Test
    @DisplayName("팔로우 실패 테스트 (이미 팔로우 한 경우)")
    @WithMockJwtAuthentication
    ...
    @Test
    @DisplayName("팔로우 실패 테스트 (없는 유저를 팔로우 한 경우)")
    @WithMockJwtAuthentication
    ...
    @Test
    @DisplayName("팔로우 체크 테스트 (팔로우 한 경우)")
    @WithMockJwtAuthentication
    ...
    @Test
    @DisplayName("팔로우 체크 테스트 (팔로우 안 한 경우)")
    @WithMockJwtAuthentication
    ...
    @Test
    @DisplayName("언팔로우 실패 테스트 (이미 언팔로우 한 경우)")
    @WithMockJwtAuthentication
    ...
    @Test
    @DisplayName("언팔로우 실패 테스트 (없는 유저를 언팔로우 한 경우)")
    @WithMockJwtAuthentication
